...
<main>
  ...
  <section class="lead-page-section mb-5"
    style="background-image: url(<?php bloginfo('url'); echo '/wp-content/uploads/2023/09/search.jpg' ?>)">
    <div class="container">
      <div class="row">
        <div class="col-12 col-sm-9 col-md-8 col-lg-6 col-xl-5">
          <article class="lead-section-content px-4 py-5 animation" data-animation="slide-right">
            <h1 class="lead-section-title mb-4"><span class="text-uppercase">Search <br> result for: <br></span>
