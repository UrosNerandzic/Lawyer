...
<p class="info-phone animation" data-animation="slide-top" data-delay="0.2s">
  ...
  <a href="<?php echo $mobile_1; ?>"><?php echo $mobile_1; ?></a>
  <?php
}
?>
...
<p class="info-phone animation" data-animation="slide-top" data-delay="0.2s">
  <span class="fas fa-mobile-alt"></span>
  <a href="<?php echo $mobile_2; ?>"><?php echo $mobile_2; ?></a>
  <?php
}
?>
...
<p class="info-email animation" data-animation="slide-top" data-delay="0.4s">
  ...
  <a href="<?php echo $email_1; ?>"><?php echo $email_1; ?></a>
</p>
<?php
}
?>
...
<p class="info-email animation" data-animation="slide-top" data-delay="0.4s">
  <span class="far fa-envelope"></span>
  <a href="<?php echo $email_2; ?>"><?php echo $email_2; ?></a>
</p>
<?php
}
?>