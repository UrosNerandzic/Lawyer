<section class="team-section bg-light">
  <div class="container">
    <div class="section-header d-lg-flex justify-content-lg-between align-items-lg-center mb-5">
      ...
      <a href="<?php the_field('homepage_team_link'); ?>"
        class="team-more"><?php the_field('homepage_team_link_text'); ?></a>
    </div>
    <!--.section-header-->
        ...
        <div class="row">
          <div class="col-12 col-sm-6 mb-4 mb-sm-0">
            <article class="team-member-content">
              ...
              <a href="<?php the_field('member_li'); ?>" class="fab fa-linkedin-in"></a>
            </article>
          </div>
    ...
    <?php
          ...
          ?>
    <div class='jumbotron'>
      <h3>The are no members to show.</h3>
    </div>
    <?php
        }
        wp_reset_postdata();
