          ...
          <article class="lead-section-content px-4 py-5 animation" data-animation="slide-right">
            <p class="text-primary mb-4">
              ...
              <?php
                ...
                ?>
              <a href='<?php echo get_category_link($newsCategory ->term_id) ?>'
                class="category text-uppercase"><?php echo $newsCategory -> name ?></a>
              <?php
                  }
                ?>
        ...
        <div class="col-12 col-lg-10 col-xl-8">
          ...
          <article class="news-tags">
            ...
            <div class="tags">
              ...
              ?>
              <a href="<?php echo get_tag_link($newsTag ->term_id) ?>"
                class="btn btn-light text-primary px-4 py-2"><?php echo $newsTag -> name ?></a>
              <?php
                }
              ?>
